...
public class AppDetail {
	...
	public  onAwardClickListener monAwardClickListener;
	private static AppDetail adDetail;
	private final Handler mHandler = new Handler();

	public void addAwardClickListener(onAwardClickListener obj){
		monAwardClickListener=obj;
	}
	
	public void notifactionUpdate(int score){
		monAwardClickListener.updatAward(score);
	}
