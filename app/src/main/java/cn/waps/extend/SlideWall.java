...
public class SlideWall {
	...
	public LinearLayout getView(final Context context, int handleMarginLeft, int itemWidth, int itemHeight) {
		...
		try {
			...
			int slidingDrawerLayout_id = context.getResources().getIdentifier("slidingdrawerLayout", "id",
			...
			final int handle_down_img_id = context.getResources().getIdentifier("handle_down", "drawable",
					context.getPackageName());
